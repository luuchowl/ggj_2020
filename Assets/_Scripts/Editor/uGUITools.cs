...
{
	[UnityEditor.MenuItem("Tools/uGUI/Anchors to Corners %[")]
	...
	[UnityEditor.MenuItem("Tools/uGUI/Corners to Anchors %]")]
	...
	[UnityEditor.MenuItem("Tools/uGUI/Mirror Horizontally Around Anchors %;")]
	static void MirrorHorizontallyAnchors()
	{
		MirrorHorizontally(false);
	}

	[UnityEditor.MenuItem("Tools/uGUI/Mirror Horizontally Around Parent Center %:")]
	...
	[UnityEditor.MenuItem("Tools/uGUI/Mirror Vertically Around Anchors %'")]
	static void MirrorVerticallyAnchors()
	{
		MirrorVertically(false);
	}

	[UnityEditor.MenuItem("Tools/uGUI/Mirror Vertically Around Parent Center %\"")]
